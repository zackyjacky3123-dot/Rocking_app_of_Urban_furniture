...
def receive_goods(
    ...
    for receive_item in data.items:
        ...
        if new_received_quantity > order_item.quantity:
            raise HTTPException(
                status_code=400,
                detail=(
...
def create_vendor_bill(
    ...
    #
    # Purchase Expense     Dr
    # Tax Payable          Dr/Cr depending on model
    # Creditors            Cr
    #
    # For our simplified system:
    #
    # Purchase Expense     Dr subtotal
    # Tax Payable           Dr/Cr needs proper tax treatment
    #
    # Since our current Tax Payable is a liability and
    # purchase tax is typically recoverable input tax,
    # we should NOT incorrectly credit Tax Payable here.
    #
    # Therefore this first version records the purchase
    # at total amount:
    #
    # Purchase Expense     Dr total
    # Creditors            Cr total
    # -----------------------------------------------------
    ...
    journal_entry = create_journal_entry(
        ...
        description=(
            f"Vendor bill {data.bill_number}"
        ),
